/*!
 * _UT JavaScript Library v0.1
 * http://ddallala.github.com/UT
 *
 * Copyright 2011, ddallala
 ...
 *
 * Date: Thu Nov 17 19:00:00 2011 -0500
 */
...
/* 
 * Start of _UT definition
 *     influenced by jQuery Core
 */
var _UT = (function () {
    ...
    _UT.extend({
        ...
        // More details: http://docs.jquery.com/Utilities/_UT.browser
        uaMatch: function (ua) {
            ua = ua.toLowerCase();
        ...
        /***************************************************************
         *  UT Extension installed
         ***************************************************************/
        /**
         * UT addExtensions
         * @param {object} object where key is name of function and value is the new function
         */
        ...
        addPlugins: function (plugins, type) {
            if (typeof plugins == "object") {
                for (var name in plugins) {
                    ...
                    if (type) { // take the second aegument
    ...
    _UT.Adapter = Class.extend({
         ...
         * @param {object} arguments used in logic
         */
        fire: function (vars) {
            try {
         ...
         * @param {string} a string representing the key as found in args
         * @param {object} represent the scope where the search variable should occur
         * @param {boolean} if var not found in scope, then search in window
         ...
         * @param {object} variables to parse
         *            special properties:
    ...
    _UT.Container = Class.extend({
         ...
         * @method {string} name of methods
         * @props {object} properties of the call method
